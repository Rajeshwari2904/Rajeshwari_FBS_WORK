...
class EmployeeDowncasting
{
   public static void main(String[] args)
    {
	         ...
	         e1 = new Manager(101, "Raj", 34000, 20, 45000);
	         EmployeeDowncasting.myfun(e1);
	         
	         System.out.println();
	         
	         e1 = new HR(111, "Snaika", 50000, 60000); 
	         EmployeeDowncasting.myfun(e1);
   ...
   static void myfun(EmployeeDetails e1) 
   {
	   ...
	   if(e1 instanceof Manager) {
		   ...
		   System.out.println(M1.getincentive());
